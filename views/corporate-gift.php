					...
					<div class="col-lg-7 px-6 px-xl-10 order-1 order-lg-0">
						<div class="py-lg-22 py-14 pe-xl-14 mt-lg-3 mb-lg-5 ms-lg-auto content-wrap">
							<div class="text-left">
								...
								<h1 data-animate="fadeInUp" class="mx-auto font-primary text-white fs-30px fs-xl-1 mb-8">Corporate Gifts</h1>

								<p data-animate="fadeInUp" class="text-white fs-18px mb-0">
								    Reward your best customers!<br>
								    Tingkatkan loyalitas pelanggan melalui gift perusahaan.<br>
								    Selain itu dengan melampirkan Daftar Nominatif di Surat Pemberitahuan Tahunan, perusahaan Anda bisa mengajukan biaya gifting customer sebagai pengurang penghasilan bruto.
								</p>
							</div>
		
							<a data-animate="fadeInUp" href="https://api.whatsapp.com/send?phone=628122883155&text=Halo%20Debi%2C%20saya%20ingin%20tanya%20mengenai%20corporate gift perusahaan saya. Bisa dibantu?" class="btn btn-lg btn-secondary mt-8 hover-shine">Konsultasi Sekarang</a>
						</div>
					</div>
