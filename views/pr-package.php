			...
			<div class="container container-xxl">
				<div class="row">
					<div class="col-lg-7 px-6 px-xl-10 order-1 order-lg-0">
						<div class="py-lg-18 py-14 pe-xl-14 mt-lg-3 mb-lg-5 ms-lg-auto content-wrap">
							<div class="text-left">
								<p data-animate="fadeInUp" class="text-white fs-18px mb-3">OUR SOLUTIONS</p>
								<h1 data-animate="fadeInUp" class="mx-auto font-primary text-white fs-30px fs-xl-1 mb-8">PR Package</h1>

								<p data-animate="fadeInUp" class="text-white fs-18px">Brand awareness meningkat, bisnis makin cuan.</p>
								
								<ul data-animate="fadeInUp" class="list-unstyled text-white fs-18px ">
									<li><i class="fa fa-check me-4"></i> Promosi dari influencer secara organik</li>
									<li><i class="fa fa-check me-4"></i> Produk Anda makin dikenal luas</li>
									<li><i class="fa fa-check me-4"></i> Meningkatkan citra dan reputasi produk</li>
									<li><i class="fa fa-check me-4"></i> Menarik perhatian calon pelanggan Anda</li>
								</ul>
								
								<p data-animate="fadeInUp" class="text-white fs-18px mb-0">
								    Kami siap membantu dari proses kreatif hingga pengiriman PR package untuk influencer dan media yang cocok untuk bisnis Anda.
								</p>
							</div>
							
							<a href="https://api.whatsapp.com/send?phone=628122883155&text=Halo%20Debi%2C%20saya%20ingin%20tanya%20mengenai%20PR Package brand dan produk saya. Bisa dibantu?" class="btn btn-lg btn-secondary mt-8 hover-shine">Konsultasi Sekarang</a>
						</div>
					</div>
			...
			<div class="container container-xxl">
				<div class="row align-items-center mb-lg-4 pb-3">
					<div class="col-xl-5 col-lg-6 mb-lg-0 order-1 order-lg-1 ps-10" data-animate="fadeInUp">
    					...
    					<a data-animate="fadeInUp" href="https://api.whatsapp.com/send?phone=628122883155&text=Halo%20Debi%2C%20saya%20ingin%20tanya%20mengenai%20gift%20dan%20merchandise%20perusahaan"
					...
					<div class="col-lg-6 py-lg-12 pt-15 order-0 order-lg-0" data-animate="fadeInUp">
						<img data-src="assets/images/static/cta-img2.webp" alt="Delovery Bisnis Contact" class="img-fluid lazy-image" loading="lazy" width="628" height="650" src="assets/images/placeholder.webp">
					</div>
				</div>
			</div>
		</section>	
					...
					<div class="col-md-8">
						<div class="accordion accordion-flush" id="FAQ">
							...
							<div id="flush-collapseReturnsOne" class="accordion-collapse collapse" aria-labelledby="flush-headingReturnsOne" data-bs-parent="#FAQ">
								<div class="py-8">
									<p>
										Delovery Bisnis adalah layanan Delovery yang membantu perusahaan mengirim gift dan merchandise untuk customer dan relasi bisnis dengan mudah dan cepat. Dengan Delovery Bisnis, Anda juga bisa melakukan penjadwalan pengiriman hadiah.
Delovery akan mengatur urusan gift dan merchandise sesuai kebutuhan hingga ke proses pengiriman. Dijamin aman dan praktis.
									</p>
								</div>
							</div>
