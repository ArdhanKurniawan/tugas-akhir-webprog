...
$link = "https://api.whatsapp.com/send?phone=62811279577&text=Halo%20Debi%2C%20saya%20ingin%20tanya%20mengenai%20gift%20dan%20merchandise%20perusahaan";
if(isset($_GET['tsrc'])) {
	$trafik = $this->TrafikModel->view($_GET['tsrc']);
	if ($trafik) $link = "https://chat.delovery.com/cta";
}
            ...
            <div class="container-wide container flex-nowrap">
                    ...
                    <li class="nav-item transition-all-xl-1 py-xl-10 py-0 mx-xl-6 dropdown dropdown-hover dropdown-fullwidth position-static">
                        ...
                        <ul class="dropdown-menu p-0" aria-labelledby="menu-item-pages">
                            ...
                            <?php foreach ($data['solutions'] as $solutions) { ?>
                                <li>
                                    <a class="dropdown-item py-6 pe-10 ps-8 border-hover" href="solution/<?= $solutions->slug; ?>?utm_source=nav-menu&utm_medium=lg">
                ...
                <div class="icons-actions d-flex justify-content-end w-xl-50 fs-23px text-body-emphasis">
                    <div class="px-xl-5 d-inline-block d-sm-none">
                        <a href="<?= $link; ?>" class="lh-1 color-inherit text-decoration-none">
                            <i class="fa-brands fa-whatsapp"></i>
                        </a>
                    </div>
                    <div class="px-5 d-none d-xl-inline-block">
                        <a href="<?= $link; ?>" class="btn btn-secondary hover-shine">Request Quote
