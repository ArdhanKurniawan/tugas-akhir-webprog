					...
					<div class="col-lg-7 px-6 px-xl-10 order-1 order-lg-0">
						<div class="py-lg-22 py-14 pe-xl-14 mt-lg-3 mb-lg-5 ms-lg-auto content-wrap">
							<div class="text-left">
								...
								<h1 data-animate="fadeInUp" class="mx-auto font-primary text-white fs-30px fs-xl-1 mb-8">Event Merchandise</h1>

								<p data-animate="fadeInUp" class="text-white fs-18px mb-0">
									Acara sukses butuh perhatian pada setiap detail, termasuk merchandise. <br>Jangan khawatir! Delovery siap membantu Anda menyelesaikan masalah ini. Kami memberikan solusi lengkap untuk kebutuhan merchandise acara Anda.
								</p>
							</div>
		
							<a href="https://api.whatsapp.com/send?phone=628122883155&text=Halo%20Debi%2C%20saya%20ingin%20tanya%20mengenai%20event merchandise perusahaan saya. Bisa dibantu?" class="btn btn-lg btn-secondary mt-8 hover-shine">Konsultasi Sekarang</a>
						</div>
					</div>
			...
			<div class="container container-xxl">
				<div class="row align-items-center mb-lg-4 pb-3">
					...
					<div class="col-lg-6 py-lg-12 pt-15 order-0 order-lg-0" data-animate="fadeInUp">
						<img data-src="assets/images/static/cta-img2.webp" src="assets/images/placeholder.webp" alt="Delovery Bisnis Contact" class="img-fluid lazy-image" width="628" height="650">
					</div>
				</div>
			</div>
		</section>	
